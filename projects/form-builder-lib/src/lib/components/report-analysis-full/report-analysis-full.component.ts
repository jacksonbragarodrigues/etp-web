...
@Component({
  selector: 'form-report-analysis-full',
  standalone: true,
  imports: [CommonModule],
  template: `<div class="report-container" [innerHTML]="html"></div>`
})
export class ReportAnalysisFullComponent implements OnChanges {
  ...
  ngOnChanges(changes: SimpleChanges): void {
    this.applyInputs();
    this.html = this.report.generateHTMLReportWithAnnotations('full');
  }
